...
There's a fully functional trial available [here](https://www.dropbox.com/scl/fi/546530yk2u6spklr0ufvb/Dato-5.2.6-trial-1710500381.zip?rlkey=3omdv5qa8udw2zpbrti2yld5l&raw=1). The only limitation is that it will prompt you to buy Dato every 12 hours and it will not receive automatic updates. If you decide to buy Dato on the App Store, all data and settings from the trial version will be preserved (they share the same storage).
